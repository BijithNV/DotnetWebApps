...
namespace TwitterClone.Controllers
{
    ...
    {
        private SignInManager<TwitterCloneUser> m_signInManager;
        private UserManager<TwitterCloneUser> m_userManager;
        private ILogger<SessionController> m_logger;

        public SessionController(SignInManager<TwitterCloneUser> a_signInManager, UserManager<TwitterCloneUser> a_userManager, ILogger<SessionController> a_logger)
        {
        ...
        public async Task<JsonResult> CurrentUser()
        {
            try
            {
                if (User.Identity.IsAuthenticated)
                {
                    ...
                    return Json(Mapper.Map<TwitterCloneUserViewModel>(user));
                }
